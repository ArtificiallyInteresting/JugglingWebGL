...
public class singlePaddleQLearning
{
    ...
    int cacheHits;
    int cacheTotal;
    private Dictionary<int, Vector2> actions;

    public singlePaddleQLearning(int strength)
    {
    ...
    {
        this.actions = new Dictionary<int, Vector2>();
